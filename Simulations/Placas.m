...
for i = 1:length(x)
    for j = 1:length(x)
        ...
        try
            ...
            Ey(i, j) = 0;
            E = sqrt(Ex.^2 + Ey.^2);
            pcolor(Ex,Ey,E); colormap jet; shading interp;
            hold on
        end
    end
end
...
%Agregar el alambre 
y3=-L1/2;
rectangle('Position',[-2.1 y3 0.3 L1],'Curvature',0.7,'FaceColor',"g")
hold on

y4=-L2/2;
rectangle('Position',[1.8 y4 0.3 L2],'Curvature',0.7,'FaceColor',"#011a52")
hold on
